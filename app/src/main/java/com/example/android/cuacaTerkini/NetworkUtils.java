package com.example.android.cuacaTerkini;
...
public class NetworkUtils {
    ...
    private final static String WEATHERDB_BASE_URL=
            "http://dataservice.accuweather.com/forecasts/v1/daily/5day/208977";

    private final static String API_KEY = "oQKJ9p50FY1iHEHYfQCWkAoL8T63YRlJ";
